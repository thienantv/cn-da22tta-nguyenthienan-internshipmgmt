...
useEffect(() => {
  ...
  return (
    <div className="sv__chi_tiet_don_vi">
      ...
      <div className="sv__chi_tiet_don_vi--content">
        <div className="sv__chi_tiet_don_vi--header">
          <img
            src={donVi.hinh_anh || 'https://via.placeholder.com/600x400?text=' + donVi.ten_don_vi}
            alt={donVi.ten_don_vi}
            className="sv__chi_tiet_don_vi--image"
          />
        </div>

        <div className="sv__chi_tiet_don_vi--body">

          <div className="sv__chi_tiet_don_vi--section">
            <h3>Thông tin cơ bản</h3>
            <div className="sv__chi_tiet_don_vi--info_row">
          ...
          {donVi.can_bo_huong_dan && donVi.can_bo_huong_dan.length > 0 && (
            <div className="sv__chi_tiet_don_vi--section">
              ...
              <div className="sv__chi_tiet_don_vi--can_bo_list">
                {donVi.can_bo_huong_dan.map((cb) => (
                  <div key={cb.ma_can_bo} className="sv__chi_tiet_don_vi--can_bo_item">
                    <h4>{cb.ho_ten}</h4>
